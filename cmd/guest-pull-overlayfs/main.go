...
func main() {
	app := &cli.App{
		Name:      "GuestPullOverlayfs",
		Usage:     "FUSE mount helper for containerd to filter out Guest Pull specific options",
		Version:   fmt.Sprintf("%s.%s", Version, BuildTime),
		UsageText: "[Usage]: guest-pull-overlayfs overlay <target> -o <options>",
